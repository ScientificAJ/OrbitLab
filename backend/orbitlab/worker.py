...
from orbitlab.science.mast import extract_light_curve_from_tpf
...
def run_analysis_job(self, job_id: str) -> str:
    ...
    with SessionLocal() as db:
        ...
        try:
            ...
            time, flux, quality = extract_light_curve_from_tpf(job.product_uri, aperture_mask=aperture_mask)
